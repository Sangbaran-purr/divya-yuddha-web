/* NEGATIVE-CONTROL FIXTURE — S-HALL-SUITE-1 (R4).
 * A copy of mp/matchclient.js FROZEN AT ITS PRE-FIX-1 STATE (?v=mpa5). It is NEVER a source of truth and must
 * never be edited to match the live client: its whole value is being the old code. fixtures/neg.js drives it to
 * prove the auth race S-HALL-L3-FIX-1 closed was real — that a session given authConnected() before the challenge
 * genuinely never authenticated, and the server never saw it.
 */
