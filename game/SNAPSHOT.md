...
- Source commit: `213faede1aea4b39aba53d90ea8eb0d0c1033f03` (213faed)
- Source committed: 2026-08-14 17:26:35 +0530
...
- game/ in-repo size: 1752 KB.

## Entry-link stamps (S8 flag-1)
- The ten site->game links (rite.html x3, index.html x2, treasury.html x1, demo/index.html x1, store.html x1, explore.html x1, mint.html x1) are stamped game/index.html?v=213faed — bound to this HEAD short sha, so they change exactly when the copy changes. The sync fails if the link count is not exactly 10.
